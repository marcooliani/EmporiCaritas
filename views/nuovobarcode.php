...
<div class="col-md-12">
    <div class="row">
        <div class="col-sm-9 col-md-9 col-lg-10 col-main">
			<div style="float:left; height:100%; width:100%;">
				...
				<div class="panel panel-default"  style="height:100%; background:#FFFFFF">
					<div class="panel-heading"><i class="fa fa-barcode" aria-hidden="true"></i> <strong>INSERIMENTO BARCODE</strong></div>
						<div class="panel-body" style="height:93%; overflow-y:auto; ">
							...
							<form id="nuova_prodotto" method="POST" action="/barcodes/inserisci">
							<input type="hidden" name="id_tipologia" id="id_tipologia" value="<?php echo $id_tipologia; ?>">
							<input type="hidden" name="doppione" id="doppione" value="">
							<div class="well well-sm">
							  <div class="row">
								<div class="col-sm-3 col-md-3 col-lg-3">
									<div class="form-group">
										<label for="exampleInputEmail1">Barcode *</label>
										<input type="text" class="form-control" id="barcode" name="barcode" tabindex="1" placeholder="Inserire barcode" autofocus>
									</div>
								</div>
								<div class="col-sm-2 col-md-2 col-lg-2">
									<div class="form-group">
										...
										<select class="form-control" name="categoria" id="categoria" tabindex="2">
											...
											<?php
												foreach($sql_categorie as $key=>$val) {
													print("<option value='".$val['id_categoria']."'>".ucfirst($val['descrizione_categoria'])."</option>");
												}
											?>
										</select>
									</div>
								...
								<div class="col-sm-2 col-md-2 col-lg-2">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="stock" name="stock" tabindex="5" placeholder="Inserire num. pezzi ">
									</div>
								</div>
							  </div>
						<!--	</div>
								...
								<div class="row">
									<div class="col-sm-8 col-md-8 col-lg8">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="descrizione" name="descrizione" tabindex="6" placeholder="Inserire descrizione">
										</div>
									</div>
									<div class="col-sm-2 col-md-2 col-lg-2">
										<div class="form-group">
									...
									<div class="col-sm-2 col-md-2 col-lg-2">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="contenuto_um1" name="contenuto_um1" tabindex="8" placeholder="Inserire valore formato">
										</div>
									</div>
                                </div>
                                <div class="row">
                            ...
                            <div class="well well-sm">
                                <div class="row">
									<div class="col-sm-4 col-md-4 col-lg-4">
										<div class="form-group">
                                            <label for="exampleInputEmail1">Fornitore *</label>
                                            <select class="form-control" name="fornitore" id="fornitore" tabindex="11">
                                                <option value="" selected disabled> -- Seleziona -- </option>
												<?php
                                                    foreach($sql_donatori as $key=>$val) {
                                                        print("<option value='".$val['id_fornitore']."' flag_d='".$val['donatore']."'>".ucwords($val['ragione_sociale'])."</option>");
                                                    }
                                                ?>
                                            </select>
                                        </div>
                                ...
                                <div class="row">
									<div class="col-sm-2 col-md-2 col-lg-2">
										<div class="form-group">
                                            <label for="exampleInputEmail1">Doc. consegna *</label>
                                            <input type="text" class="form-control" name="ddt" id="ddt" tabindex="12" placeholder="Inserire num. doc.">
                                        </div>
									</div>
                                    <div class="col-sm-2 col-md-2 col-lg-2">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Num. lotto </label>
                                            <input type="text" class="form-control" name="lotto" id="lotto" tabindex="13" placeholder="Inserire lotto">
                                        </div>
                                    </div>
                                    <div class="col-sm-2 col-md-2 col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" data-provide="datepicker">
                                                <input type="text" class="form-control" id="scadenza" name="scadenza" value="<?php echo date("d/m/Y"); ?>" tabindex="14">
									...
									<div class="col-sm-2 col-md-2 col-lg-2">
										<div class="form-group">
											<label for="exampleInputEmail1">Acquistato</label>
											<select class="form-control" name="acquistato" id="acquistato" tabindex="15">
												<option value="f">No</option>
												<option value="t">S&igrave;</option>
											</select>
										</div>
									...
									<div class="col-sm-2 col-md-2 col-lg-2">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Data inserimento *</label>
                                            <div class="input-group date" data-provide="datepicker">
                                                <input type="text" class="form-control" id="data_donazione" name="data_donazione" value="<?php echo date("d/m/Y"); ?>" tabindex="16">
                                                <div class="input-group-addon">
                                                    <span class="fa fa-calendar"></span>
                                                </div>
                                            </div>
        ...
        <div class="col-sm-3 col-md-3 col-lg-2 col-right">&nbsp;
			...
			<div>&nbsp;</div>
			<button type="submit" class="btn btn-success btn-sm btn-block" tabindex="17"><i class="fa fa-plus" aria-hidden="true"></i> Inserisci</button>
			<button type="reset" class="btn btn-danger btn-sm btn-block" tabindex="18"><i class="fa fa-times" aria-hidden="true"></i> Reset</button>
			</form>
...
/*	$('#agea').change(function() {
        var f = $('select#agea option:selected').attr('value');

        if(f == 't')
            $('#ddt').prop('disabled', false);
        else {
            $('#ddt').prop('disabled', true);
			$('#ddt').val('');
		}
    }); */
...
<script type="text/javascript">
 $(document).ready(function(){
	...
	//		$('#warning_doppione').html('<div style="text-align:center; width:80%; margin:auto;" class="alert alert-warning alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>Attenzione!</strong> Prodotto gi&agrave; presente nel database: la quantit&agrave; inserita nel campo &quot;Stock&quot; verr&agrave; sommata a quella gi&agrave; esistente</div><div class="row">&nbsp;</div>');
			...
			$('#id_tipologia').prop('readonly', true);
			$('#um_stock').prop('readonly', true);
            $.ajax({
                type: "POST",
                url: "/categorie/ajax_misure_doppione",
                data: {'id':ui.item.id_categoria , 'selected':ui.item.um_1 },
                dataType: "html",
                success: function(data) {
                    $("select#um1").html(data);
                }
...
//			$('#um1').val(ui.item.um_1);
			$('#um1').prop('readonly', true);
			$('#contenuto_um1').val(ui.item.contenuto_um1);
			$('#contenuto_um1').prop('readonly', true);
...
$(document).ready(function(){
    $('form').validate({
        ...
        rules: {
                    ...
                    stock: { required: true, regex: /^[1-9]\d*$/ },
                    ...
                    ddt: { required: true, regex: /^[0-9A-Za-z\-\/]+$/ },
                    lotto: { required: false, regex: /^[0-9A-Za-z\-\/]+$/ },
                    scadenza: { required: false, regex: /^(((0[1-9]|[12]\d|3[01])\/(0[13578]|1[02])\/((19|[2-9]\d)\d{2}))|((0[1-9]|[12]\d|30)\/(0[13456789]|1[012])\/((19|[2-9]\d)\d{2}))|((0[1-9]|1\d|2[0-8])\/02\/((19|[2-9]\d)\d{2}))|(29\/02\/((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$/ },
                    note: { required: false, regex: /^[0-9 A-Za-z\'\.\,\:\;\?\!\-_àèìòù]+$/ },
