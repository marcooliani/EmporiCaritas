        ...
        <div class="col-sm-9 col-md-9 col-lg-10 col-main">
			<div style="float:left; height:100%; width:100%;">
				...
				<div class="panel panel-default"  style="height:100%; background:#FFFFFF">
					<div class="panel-heading"><i class="fa fa-barcode" aria-hidden="true"></i> <strong>MODIFICA TIPOLOGIA DI PRODOTTO </strong></div>
						<div class="panel-body" style="height:93%; overflow-y:auto; ">
							...
							<form id="modifica_tipologia" method="POST" action="/tipologie/update_tipologia/<?php echo $tipologia; ?>">
							  ...
							  <div class="row">
								<div class="col-sm-4 col-md-4 col-lg-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="descrizione_tipologia" name="descrizione_tipologia" 
											value="<?php echo ucwords($val['descrizione_tipologia']); ?>" tabindex="1" autofocus>
									</div>
								</div>
								<div class="col-sm-3 col-md-3 col-lg-3">
									<div class="form-group">
										...
										<select class="form-control" id="id_categoria" name="id_categoria" tabindex="2">
											<?php
												foreach($ris_cat as $key=>$val2) {
													if($val['categoria'] == $val2['id_categoria'])
														$selected = "selected";
													else
														$selected = "";
													print("<option value='".$val2['id_categoria']."' ".$selected.">".ucwords($val2['descrizione_categoria'])."</option>");
												}
											?>
										</select>
									</div>
								...
								<div class="col-sm-1 col-md-1 col-lg-1">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="punti" name="punti" value="<?php echo $val['punti']; ?>" tabindex="3">
									</div>
								</div>
                              </div>
                              <div class="row">
								<div class="col-sm-2 col-md-2 col-lg-2">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="warning_qta_minima" name="warning_qta_minima"
											value="<?php echo $val['warning_qta_minima']; ?>"  tabindex="4">
									</div>
								</div>
								<div class="col-sm-2 col-md-2 col-lg-2">
									<div class="form-group">
										<label for="exampleInputEmail1">Livello critico stock *</label>
										<input type="text" class="form-control" id="danger_qta_minima" name="danger_qta_minima" value="<?php echo $val['danger_qta_minima']; ?>"  tabindex="5">
									</div>
								</div>
                                <div class="col-sm-1 col-md-1 col-lg-1">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Et&agrave; min</label>
                                        <input type="text" class="form-control" id="eta_min" name="eta_min" tabindex="6" value="<?php echo $val['eta_min']; ?>" placeholder="Es: 3">
                                    </div>
                                </div>
                                <div class="col-sm-1 col-md-1 col-lg-1">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Et&agrave; max</label>
                                        <input type="text" class="form-control" id="eta_max" name="eta_max" tabindex="7" value="<?php echo $val['eta_max']; ?>" placeholder="Es: 10">
                                    </div>
                                </div>
							  </div>
							</div>
