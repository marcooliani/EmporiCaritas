        ...
        <div class="col-sm-9 col-md-9 col-lg-10 col-main">
			<div style="float:left; height:100%; width:100%;">
				...
				<div class="panel panel-default"  style="height:100%; background:#FFFFFF">
					<div class="panel-heading"><i class="fa fa-ban" aria-hidden="true"></i> <strong>NUOVO LIMITE </strong></div>
						<div class="panel-body" style="height:93%; overflow-y:auto; ">
							...
							<form id="nuovo_limite" method="POST" action="/limiti/inserisci">
									...
									<table class="table table-responsive" style="border: 1px solid #ddd">
										...
										<tbody>
											...
											<tr>
                                                ...
                                                <td> <input type="text" class="form-control" id="lim_1c_spesa" name="lim_1c_spesa"> </td>
                                                <td> <input type="text" class="form-control" id="lim_2c_spesa" name="lim_2c_spesa"> </td>
                                                <td> <input type="text" class="form-control" id="lim_3c_spesa" name="lim_3c_spesa"> </td>
                                                <td> <input type="text" class="form-control" id="lim_4c_spesa" name="lim_4c_spesa"> </td>
                                                <td> <input type="text" class="form-control" id="lim_5c_spesa" name="lim_5c_spesa"> </td>
                                                <td> <input type="text" class="form-control" id="lim_6c_spesa" name="lim_6c_spesa"> </td>
                                                <td> <input type="text" class="form-control" id="lim_7c_spesa" name="lim_7c_spesa"> </td>
                                                <td> <input type="text" class="form-control" id="lim_8c_spesa" name="lim_8c_spesa"> </td>
                                                <td> <input type="text" class="form-control" id="lim_9c_spesa" name="lim_9c_spesa"> </td>
                                                <td> <input type="text" class="form-control" id="lim_10c_spesa" name="lim_10c_spesa"> </td>
												<td style='width:10%'> &nbsp; </td>
                                            </tr>
                                            <tr>
                                                <th id='lim_mese' class='info'>Limite mensile *</th>
												<td> <input type="text" class="form-control" id="lim_1c_mese" name="lim_1c_mese"> </td>
                                                <td> <input type="text" class="form-control" id="lim_2c_mese" name="lim_2c_mese"> </td>
                                                <td> <input type="text" class="form-control" id="lim_3c_mese" name="lim_3c_mese"> </td>
                                                <td> <input type="text" class="form-control" id="lim_4c_mese" name="lim_4c_mese"> </td>
                                                <td> <input type="text" class="form-control" id="lim_5c_mese" name="lim_5c_mese"> </td>
                                                <td> <input type="text" class="form-control" id="lim_6c_mese" name="lim_6c_mese"> </td>
                                                <td> <input type="text" class="form-control" id="lim_7c_mese" name="lim_7c_mese"> </td>
                                                <td> <input type="text" class="form-control" id="lim_8c_mese" name="lim_8c_mese"> </td>
                                                <td> <input type="text" class="form-control" id="lim_9c_mese" name="lim_9c_mese"> </td>
                                                <td> <input type="text" class="form-control" id="lim_10c_mese" name="lim_10c_mese"> </td>
                                                <td style='width:10%'> &nbsp; </td>
											</tr>
										</tbody>
									</table>
